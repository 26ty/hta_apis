...
type Entity interface {
	...
	GetByDocumentID(input *model.Field) (amount int64, output []*model.FilebydocumentId, err error)
	GetByDocumentIDUserID(input *model.Users) (amount int64, output []*model.FilebydocumentId, err error)
