...
type Entity interface {
	...
	GetByJIDJigDetailListUser(input *model.Field) (output *model.Table, err error)
	JigDetailListUser(input *model.Fields) (amount int64, output []*model.Table, err error)
	GetByUserIDListJD(input *model.Users) (amount int64, output []*model.JD, err error)
}
