...
type Resolver interface {
	...
	GetByUserIdLaborHourList(input *model.Field) interface{}
	GetByCuIdLaborHourList(input *model.Field) interface{}
	GetByUserIdList(input *model.Field) interface{} 
	GetByUserIdCategoryList(input *model.Field) interface{}
	GetByUserIdCategory(input *model.Field) interface{}
	GetByUserIdMonthList(input *model.Field_Month) interface{}
