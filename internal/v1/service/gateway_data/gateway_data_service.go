...
func (s *service) GetByClassificationTitle(input *model.Field) (output *model.Base, err error) {
	field, err := s.Entity.GetByClassificationTitle(input)
	if err != nil {
		log.Error(err)
...
func (s *service) GetByDataDemand(input string) (output *[]gg_data_demand.Review, err error) {
	field, err := s.Entity.GetByDataDemand(input)
	if err != nil {
		log.Error(err)
